...
function makearXiv(feed)
{
    ...
    for (x=0; x<num_entries; x++) {
      ...
      html += '\t\t\t'+ '<a  class="btn btn-arxiv" href="' + feed.entries[x].id.substring(0, feed.entries[x].id.length - 2) + '" role="button">arXiv:'+feed.entries[x].id.substring(21, feed.entries[x].id.length - 2)+'</a><br/>' + '<em><b>' + feed.entries[x].title+ '</b></em>'+'\n\t\t</div>';
      }
